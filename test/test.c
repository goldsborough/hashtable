...
// for testing we need the hidden HashTable struct
...
int tests(int argc, const char* argv[]) {
	...
	HashTable * table = NULL; // dbj chaned HT_INITIALIZER;
	...
	return printf( VT100_LIGHT_GREEN  "\n\nALL TEST PASSED" VT100_RESET );
}
